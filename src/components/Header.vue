<script setup>
    ...
    defineEmits(['aumentar-cantidad', 'disminuir-cantidad', 'agregar-carrito', 'eliminar-producto', 'vaciar-carrito'])
                    ...
                    >
                        ...
                        <div id="carrito" class="bg-white p-3">
                            ...
                            <div v-else>
                                ...
                                <button v-if="carrito.length > 0" @click="$emit('vaciar-carrito')" class="btn btn-dark w-100 mt-3 p-2">Vaciar Carrito</button>
                            </div>
